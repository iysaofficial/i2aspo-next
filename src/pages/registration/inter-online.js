              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Indonesia International Applied Science Project Olympiad - Online Competition">
                      Online Competition
                    </option>
                    <option value="Indonesia International Applied Science Project Olympiad - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Indonesia International Applied Science Project Olympiad - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
